...
---------------------------------------------------------------------
Similar Posts:
- [[https://code.dennyzhang.com/encode-and-decode-tinyurl][Encode and Decode TinyURL]]
- [[https://code.dennyzhang.com/design-url-redirect][A URL Redirecting Feature]]
...
e.g, from https://code.dennyzhang.com/design-tiny-url to [[url-external:https://goo.gl/ojcPMV][https://goo.gl/ojcPMV]].
...
Related Reading: [[https://code.dennyzhang.com/design-rest-api][Common Mistakes In REST API Design]]
...
| id | new_url                          | old_url                         |
|----+----------------------------------+---------------------------------|
|  1 | https://code.dennyzhang.com/... | https://mytinyurl.com/ojcPMV... |
